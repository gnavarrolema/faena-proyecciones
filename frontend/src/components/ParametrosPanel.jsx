  ...
  const fields = [
    ...
    },
    {
      section: 'Planificación Gerente', description: 'Ajustes de priorización para el modo gerente dentro del horizonte semanal operativo.', items: [
        ...
        { key: 'pollos_viernes_puente', label: 'Cap viernes puente (pollos)', step: 100, type: 'int', help: 'Capacidad máxima de pollos asignados al día viernes cuando se activa el viernes puente. 0 = sin límite adicional (usa capacidad con horas extras).' },
      ]
    },
    {
