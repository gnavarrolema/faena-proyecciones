  ...
  const fields = [
    ...
    },
    {
      section: 'Planificación Gerente', description: 'Ajustes de priorización para el modo gerente dentro del horizonte semanal operativo.', items: [
        { key: 'usar_feriados_nacionales', label: 'Usar feriados nacionales', type: 'bool', help: 'Si está activo, el calendario salta feriados nacionales además de los feriados personalizados. Desactívelo cuando la planta trabaje esos días.' },
